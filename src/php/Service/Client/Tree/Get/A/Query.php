...
class Query
{
    ...
    const A_RES_CLIENT_ID = 'clientId'; // see \Praxigento\Milc\Bonus\Api\Service\Data\Tree\Entry
    const A_RES_PARENT_ID = 'parentId'; // see \Praxigento\Milc\Bonus\Api\Service\Data\Tree\Entry
    /**/
    const BND_DATE = 'date';
